...
{
    [Theory, InlineData("TEXT/PLAIN"), InlineData("Text/Plain"), InlineData("text/PLAIN")]
    ...
    [Theory, InlineData("TEXT/HTML"), InlineData("Text/Html"), InlineData("text/HTML")]
    ...
    [Theory, InlineData("application/json"), InlineData("application/xml"), InlineData("multipart/form-data"),
     InlineData("text/csv")]
